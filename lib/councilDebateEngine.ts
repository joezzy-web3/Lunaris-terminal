...
export const COUNCIL_PERSONAS: Record<AgentPersonaId, AgentPersona> = {
  QUANT: {
    id: 'QUANT',
    name: 'Quant-Omega',
    role: 'Orderflow & Momentum Engine (Bitget L2 Depth)',
    avatarIcon: 'flame',
    color: 'text-zinc-100',
  ...
  GUARDIAN: {
    id: 'GUARDIAN',
    name: 'Guardian-01',
    role: 'Deterministic Risk Arbiter (Bitget Guarded Router & 0.5% Collar)',
    avatarIcon: 'shield',
    color: 'text-zinc-200',
    borderColor: 'border-white/15',
    badgeBg: 'bg-white/5 text-zinc-300 border-white/10',
  ...
  MACRO: {
    id: 'MACRO',
    name: 'Atlas-Macro',
    role: 'Cross-Asset Strategic Lead (Bitget Funding & OI Telemetry)',
    avatarIcon: 'globe',
    color: 'text-white',
    borderColor: 'border-white/15',
    badgeBg: 'bg-white/5 text-zinc-300 border-white/10',
  ...
  NEXUS_RED: {
    id: 'NEXUS_RED',
    name: 'NEXUS-RED',
    role: 'Adversarial Red Team (Bitget Market Signals & Stress Test)',
    avatarIcon: 'skull',
    color: 'text-rose-300',
