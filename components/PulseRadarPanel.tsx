...
const PULSE_DATA: PulseAsset[] = [
  ...
  },
  {
    ...
    catalystSummary: 'Tokenized equity pre-market premium expanding as datacenter GPU demand reports cross wire.',
  ...
  },
  {
    ...
    velocity1h: 62,
    mentionsPerHour: 2890,
    catalystSummary: 'Autonomous taxi commercialization commentary conflicting with quarterly margin projections.',
    sources: { twitter: 48, reddit: 42, discord: 46 },
  },
  {
    ticker: 'MSTR',
    name: 'MicroStrategy',
